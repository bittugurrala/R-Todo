        ...
        <div className="flex-1 p-4">
            ...
            <form className="my-7" onSubmit={submitHandler}>
                ...
                <div className="flex justify-between my-5">
                    <label className="flex justify-center gap-2 text-red-500"><input type="radio" name="high-prio" value="3" checked = {prio === "3"} onChange = {(e) => setPrio(e.target.value)}/>High Priority</label>
                    <label className="flex justify-center gap-2 text-orange-300"><input type="radio" name="med-prio" value="2" checked = {prio === "2"} onChange = {(e) => setPrio(e.target.value)}/>Medium Priority</label>
                    <label className="flex justify-center gap-2 text-green-300"><input type="radio" name="least-prio" value="1" checked = {prio === "1"} onChange = {(e) => setPrio(e.target.value)}/>Least Priority</label>
                </div>
